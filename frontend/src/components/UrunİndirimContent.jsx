...
function UrunİndirimContent() {
    ...
    const preferredProducts = products.filter(product => product.tags && product.tags.includes('İndirimli'));
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className='mt-16 flex flex-col border-b-2 justify-between items-start'>
                ...
                <div className='flex flex-row items-center montserrat gap-2 mb-4'>
                    ...
                    <div className='py-4'>
                        <h1 className='text-lg font-semibold text-gray-800'>İndirimli Ürünler</h1>
                    </div>
                </div>
                                    ...
                                    >
                                        {product.imageUrls && product.imageUrls.length > 0 ? (
                                            <div className="relative w-full h-full">
                                                <div className='absolute z-10 bg-red-600 p-2 raleway text-xs text-white  top-2 left-2'>
                                                    <h1>ÖZEL FİYAT</h1>
                                                </div>
                                                <img
...
export default UrunİndirimContent;