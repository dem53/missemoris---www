...
function UrunYeniGelenContent() {
    ...
    const preferredProducts = products.filter(product => product.tags && product.tags.includes('Yeni'));
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className='mt-16 flex flex-col border-b-2 justify-between items-start'>
                ...
                <div className='flex flex-row items-center montserrat gap-2 mb-4'>
                    ...
                    <div className='py-4'>
                        <h1 className='text-lg font-semibold text-gray-800'>Yeni Gelenler</h1>
                    </div>
                </div>
                                ...
                                >
                                    {product.imageUrls && product.imageUrls.length > 0 ? (
                                        <div className="relative w-full h-full">
                                             <div className='absolute z-10 bg-green-600 p-2 raleway text-sm text-white  top-2 left-2'>
                                <h1>Yeni</h1>
                                </div>
                                            <img
...
export default UrunYeniGelenContent;
